...
def get_gcp_environment(terraform_file_name: str):
    ...
    try:
        terraform_output = open(f"{cwd}/terraform_bsides/{terraform_file_name}")
...
if __name__ == "__main__":
    ...
    status = {}
    attacker_script_file = "cmds.py"  # Name of script inside attacker container. Don't modify this name unless modified in: ./bsides/image_files/attacker/scripts
